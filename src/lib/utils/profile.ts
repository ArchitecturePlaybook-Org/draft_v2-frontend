...
export const CATEGORY_SCHEMAS: Record<string, FieldSchema[]> = {
  ...
  contractor: [
    ...
    { key: "insurance_limit", label: "Liability Insurance Limit", type: "text", placeholder: "e.g. ₹5 Cr" },
  ],
  supplier: [
  ...
  client: [
    ...
    { key: "budget_range", label: "Planned Budget Range", type: "select", options: ["<₹10 Lakhs", "₹10L-₹50L", "₹50L-₹1Cr", ">₹1Cr"] },
