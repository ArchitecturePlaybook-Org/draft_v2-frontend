  ...
  return (
    ...
    >
      <div
        ...
        className={`absolute h-8 rounded-xl transition-all duration-200 cursor-grab active:cursor-grabbing flex items-center px-4 group/bar hover:-translate-y-[2px] ${task.status === "DONE"
