  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-4 relative z-20 pointer-events-none">
        ...
        {/* ── CONTROLS & DROPDOWN (z-30, pointer-events-auto) ── */}
        <div className="flex flex-col items-end gap-2 shrink-0 relative z-30 pointer-events-auto">
          ...
          {onSaveAsTemplate && (
            <div className="relative z-50" ref={menuRef}>
              <button
                ...
                className="w-6 h-6 rounded-md flex items-center justify-center text-surface-400 hover:text-foreground hover:bg-surface-200 transition-colors opacity-0 group-hover:opacity-100 font-bold cursor-pointer"
              ...
              {menuOpen && (
                <div
                  className="absolute right-0 top-full mt-1 z-50 min-w-[170px] bg-surface-50 border border-surface-200 rounded-xl shadow-xl py-1 backdrop-blur-xl"
                ...
                >
                  <button
                    ...
                    className="w-full text-left px-4 py-2.5 text-xs font-bold text-foreground hover:bg-surface-100 transition-colors flex items-center gap-2 cursor-pointer"
                  >
      ...
      {project.location && (
        <p className="text-[10px] uppercase tracking-widest text-surface-400 mb-3 font-bold flex items-center gap-1.5 relative z-10 pointer-events-none">
          <svg className="w-3.5 h-3.5 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
          {project.location}
        </p>
      )}

      <p className="text-sm text-surface-500 text-surface-400 line-clamp-2 leading-relaxed mb-6 flex-1 relative z-10 pointer-events-none">
        {project.description || "No architectural specification provided."}
      </p>

      {/* Progress Bar */}
      <div className="mb-6 relative z-10 bg-surface-100/50 backdrop-blur-md p-4 rounded-2xl border border-white/5 dark:border-white/5 shadow-inner pointer-events-none">
      ...
      <div className="pt-5 border-t border-white/10 dark:border-white/5 flex justify-between items-center mt-auto relative z-10 pointer-events-none">
        <div className="flex gap-4">
          <div className="flex items-center gap-1.5 text-[10px] font-bold text-surface-400 bg-surface-100/50 backdrop-blur-sm px-2.5 py-1 rounded-lg">
             <svg className="w-3.5 h-3.5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>
