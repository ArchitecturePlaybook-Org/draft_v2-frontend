...
export const ProjectActionsMenu: React.FC<ProjectActionsMenuProps> = ({ project, onAssignPersonnel, onCloneProject, onOpenSettings, onOpenMaterialPreferences, onDeleteProject }) => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-52 bg-surface-100 dark:bg-slate-900/95 border border-surface-200 dark:border-slate-800/90 rounded-xl shadow-2xl backdrop-blur-xl overflow-hidden z-50 py-1 animate-fade-in-up" style={{ animationDuration: '0.15s' }}>
          <button 
          ...
          >
            <span>📦</span> Material Preferences
          </button>
