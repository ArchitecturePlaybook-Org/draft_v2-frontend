      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-xl font-bold tracking-tight text-white">
                  {isMaterialSupplier ? "🚚 Material Supplier Catalog Manager" : "Master Materials Catalog"}
                </h1>
                <span className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-md bg-blue-500/10 text-blue-400 border border-blue-500/20">
                  {materials.length} {isMaterialSupplier ? "Supplied Items" : "Master Items"}
                </span>
              </div>
              <p className="text-xs text-zinc-400">
                {isMaterialSupplier 
                  ? "Manage your company's material listings, catalog prices, stock availability, and supply rates."
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {isMaterialSupplier ? "Add Supplied Material" : "Add Material"}
          </button>
        </div>
      </div>
            ...
            <table className="w-full text-left text-xs">
              <thead className="bg-zinc-900/90 text-zinc-400 uppercase tracking-wider font-semibold border-b border-zinc-800">
                <tr>
                  ...
                  {!isMaterialSupplier && <th className="py-3 px-4">Calc Engine</th>}
