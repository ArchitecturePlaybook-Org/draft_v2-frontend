...
export default function Error({
  ...
  return (
    <div className="min-h-[500px] flex flex-col items-center justify-center p-6 text-center">
      ...
      <h2 className="text-2xl font-bold mb-2">Unexpected Page Error</h2>
      <p className="text-muted-foreground text-sm mb-6 max-w-md">
        An error occurred while loading this page. The central logger has captured the error details.
      </p>
      <button
        onClick={() => reset()}
